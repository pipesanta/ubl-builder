...
const ParamsMap: IGenericKeyValue<ParamsMapValues> = {
    ...
    alternativeDeliveryLocation: { order: 13,  attributeName: 'cac:AlternativeDeliveryLocation', min: 0, max: 1, classRef: AlternativeDeliveryLocation },
    requestedDeliveryPeriod: { order: 14,  attributeName: 'cac:RequestedDeliveryPeriod', min: 0, max: 1, classRef: RequestedDeliveryPeriod },
    promisedDeliveryPeriod: { order: 15,  attributeName: 'cac:PromisedDeliveryPeriod', min: 0, max: 1, classRef: PromisedDeliveryPeriod },
    estimatedDeliveryPeriod: { order: 16,  attributeName: 'cac:EstimatedDeliveryPeriod', min: 0, max: 1, classRef: EstimatedDeliveryPeriod },
    ...
    minimumDeliveryUnit: { order: 22,  attributeName: 'cac:MinimumDeliveryUnit', min: 0, max: 1, classRef: MinimumDeliveryUnit },
    maximumDeliveryUnit: { order: 23,  attributeName: 'cac:MaximumDeliveryUnit', min: 0, max: 1, classRef: MinimumDeliveryUnit },
...
export {
  DeliveryType as Delivery,
  AllowedParams as DeliveryTypeParams,   
}
