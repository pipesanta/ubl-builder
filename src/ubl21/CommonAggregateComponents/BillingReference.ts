...
const ParamsMap: IGenericKeyValue<ParamsMapValues> = {
    invoiceDocumentReference: { order: 1, attributeName: 'cac:InvoiceDocumentReference', min: 0, max:1, classRef: InvoiceDocumentReference },
     //                                   TODO CAC MISSING
  ...
  setInvoiceDocumentReference(value: InvoiceDocumentReference){
     if( value instanceof InvoiceDocumentReference ){
      this.attributes.invoiceDocumentReference = value
       ...
       throw "this action is not suported yet"
     }
...
export {
   BillingReference,
   AllowedParams as BillingReferenceParams
}
