...
const ParamsMap: IGenericKeyValue<ParamsMapValues> = {
  ...
  documentDescription: { order: 13, attributeName: 'cbc:documentDescription', min: 0, max: undefined, classRef: UdtIdentifier },
...
class DocumentReference extends GenericAggregateComponent {
  ...
  setCopyIndicator(value: boolean | UdtIndicator) {
    ...
    this.attributes.copyIndicator = (value instanceof UdtIndicator)
      ? value
      : new UdtIndicator(value);
    return this;
  }
