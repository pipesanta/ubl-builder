...
const ParamsMap: IGenericKeyValue<ParamsMapValues> = {
    ...
    SupplierAssignedAccountID: { order: 2,  attributeName: 'cbc:SupplierAssignedAccountID', min: 0, max: 1, classRef: UdtIdentifier },
    additionalAccountIDs: { order: 3,  attributeName: 'cbc:AdditionalAccountID', min: 0, max: undefined, classRef: UdtIdentifier },
